...
# run_worker ARMED_AFTER GSA_ARMED_AFTER ISO_AFTER KILL_HEALS GRACE MAX_TRIES AM_FAILS
run_worker() {
    TMP=$(mktemp -d)
    STUB="$TMP/stub"
    STATE="$TMP/state"
...
# --- 案例 1：小愛一直未武裝 -------------------------------------------------
OUT=$(run_worker 999 999 999 0 2 3 0)
...
OUT=$(run_worker 0 999 0 1 2 8 0)
...
OUT=$(run_worker 0 999 0 0 2 9 0)
...
OUT=$(run_worker 0 999 999 0 2 6 0)
...
OUT=$(run_worker 999 999 999 0 2 3 999)
